  ...
  const data = await deploy("SQUOVestedEscrow", {
    ...
    proxy: {
      ...
      execute: {
        ...
        args: [token, startTime, lockDuration, lockPercent,releaseDuration, usdt, price, minBuy, recipient, false, false],
      },
    },
  });
...
deploy.tags = ["PublicSaleSQUOVestedEscrow"];
